        ...
        <div className="IdentificarLunarContent">
          <div className="IdentificarLunarInfo">
            ...
            <p className="SectionInfo">
              Hemos preparado una guía completa sobre los lunares, sus formas,
              zonas frecuentes y señales de riesgo.
            </p>
            <button className="MainButton">Ir al blog</button>
          </div>
          <div className="IdentificarLunarImage">
            <img
              alt="Lunar en la piel"
              src={require("../images/cta-guia-piel.png")}
            />
          </div>
        </div>
      </div>
